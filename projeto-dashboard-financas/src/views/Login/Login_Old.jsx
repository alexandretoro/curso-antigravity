...
export function Login({ onLogin }) {
  ...
  return (
    <div className="login-container fade-in">
      {/* Mockup de Celulares da Parte Superior (Estilo Anexo 1) */}
      ...
      <div className="login-card">
        ...
        {/* Botoes de Login Social do Card */}
        <div className="social-login-grid">
          <button type="button" className="social-btn tiktok" onClick={() => handleSocialClick('TikTok')} title="Entrar com TikTok">
            <TikTokIcon />
          </button>
          <button type="button" className="social-btn facebook" onClick={() => handleSocialClick('Facebook')} title="Entrar com Facebook">
            <FacebookIcon />
          </button>
          <button type="button" className="social-btn instagram" onClick={() => handleSocialClick('Instagram')} title="Entrar com Instagram">
            <InstagramIcon />
          </button>
          <button type="button" className="social-btn reddit" onClick={() => handleSocialClick('Reddit')} title="Entrar com Reddit">
            <RedditIcon />
          </button>
          <button type="button" className="social-btn google" onClick={() => handleSocialClick('Google')} title="Entrar com Google">
            <GoogleIcon />
          </button>
        </div>

    ...
    <footer className="px-6 py-16 max-w-[1400px] mx-auto border-t border-off-black/10 mt-12">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
        <div className="md:col-span-2">
          <div className="font-display font-bold text-3xl tracking-tight mb-4">Rebola Queixo</div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-off-black/70">
            ...
            <li><a href="#sobre" className="hover:text-rosa-cereja transition-colors">Sobre a Rebola Queixo</a></li>
          </ul>
        </div>
      ...
      <div className="pt-8 border-t border-off-black/10 text-center text-sm text-off-black/50">
        &copy; {new Date().getFullYear()} Rebola Queixo Doceria. Todos os direitos reservados.
      </div>
    </footer>
  );
}
